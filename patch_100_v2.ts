...
// Now read replacing block
let replacementText = fs.readFileSync('100_replace.txt', 'utf8');

// Replace the placeholder with actual string literal template of fileContent inside backticks.
// The fileContent itself shouldn't break the enclosing backticks if we escape backticks in fileContent.
