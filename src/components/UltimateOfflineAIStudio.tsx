...
import {
  Cpu, Brain, Zap, Sparkles, Layers, Database, Activity, Sliders, Settings, Play, Pause, RotateCcw, CheckCircle2, AlertTriangle, Flame, Gauge, HardDrive, Eye, MessageSquare, Wrench, BarChart3, Network, Share2, FileCode, Lock, RefreshCw, Terminal, FastForward, Compass, Lightbulb, Bot, Minimize2, Infinity, Scissors, Repeat, AlertOctagon, Target, ShieldAlert, Shield, Microscope, Fingerprint, Globe, Key, Map, Puzzle, Mic, PackageOpen, Bug, BookOpen, GitMerge, User, AudioLines, Swords, Crosshair, Footprints, PersonStanding, Dumbbell, Mountain, Cuboid, Brush, Hammer, Pickaxe, Droplets, Sprout, Wind, ChevronRight} from "lucide-react";
