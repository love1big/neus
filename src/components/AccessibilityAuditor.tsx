...
import { Eye, Settings, Play, Save, RefreshCw, BarChart2, Layers} from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-[#0a0a0f] text-gray-200 font-sans">
      <div className="flex items-center justify-between p-4 border-b border-[#2a2b3d] bg-[#1a1b2d]">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold tracking-tight">Accessibility Auditor</h1>
        </div>
        ...
        <div className="flex-1 p-6 overflow-y-auto bg-[#0a0a0f]">
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-[#11111a] border border-[#2a2b3d] rounded-lg p-6">
              ...
              <p className="text-sm text-gray-400 mb-6">Real-time status and advanced configurations for Accessibility Auditor. All changes are hot-reloaded into the Omni Engine.</p>
