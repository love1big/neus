...
export default function BatchAIImporter() {
  return (
    <div className="flex-1 flex flex-col w-full h-full bg-[#0a0c10] text-[#c9d1d9] font-sans p-6 overflow-hidden">
      <div className="flex justify-between items-start mb-6">
        <div>
          <h1 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-red-500 mb-2 tracking-tight">
            Batch A I Importer
          </h1>
          <p className="text-[#8b949e] max-w-xl text-sm">Bulk import and tag content using Vision AI. (Restored & Upgraded 🚀)</p>
        </div>
      ...
      <div className="flex-1 grid grid-cols-3 gap-6">
        <div className="col-span-2 bg-[#161b22] border border-[#30363d] rounded-xl flex flex-col items-center justify-center relative overflow-hidden group">
            ...
            <div className="z-10 flex flex-col items-center opacity-50 group-hover:opacity-100 transition duration-500">
               <div className="mb-4 text-yellow-400"><Activity size={64} /></div>
