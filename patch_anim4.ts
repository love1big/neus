...
const regex = /else if \(lowerInput\.includes\('animation'\) \|\| lowerInput\.includes\('rig'\) \|\| lowerInput\.includes\('แอนิเมชัน'\) \|\| lowerInput\.includes\('アニメーション'\)/;

if (regex.test(code)) {
    const replacement = `else if ((lowerInput.includes('อนิเม') || lowerInput.includes('animation') || lowerInput.includes('แอนิเม')) && (lowerInput.includes('ละเอียด') || lowerInput.includes('ลึก') || lowerInput.includes('detail') || lowerInput.includes('มากๆ'))) {
       ...
       } else if (lowerInput.includes('animation') || lowerInput.includes('rig') || lowerInput.includes('แอนิเมชัน') || lowerInput.includes('アニメーション')`;
